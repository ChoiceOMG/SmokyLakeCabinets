...
export interface MaterialPreferencesState {
...
export const materialPreferencesReducer = (
  state = initialState,
  action: MaterialPreferencesAction
): MaterialPreferencesState => {
  switch (action.type) {
