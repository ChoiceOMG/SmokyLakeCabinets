...
const [newQuestion, setNewQuestion] = useState<Question>({
  ...
  setQuestions((prev) => {
    ...
    let newId: number;
    do {
      newId = parseInt(Math.round(Math.random() * 1000).valueOf().toString().slice(0, 5), 10);
    } while (updatedList.some((question) => question.id === newId));
    
    updatedList.push({ ...newQuestion, id: newId });
    return updatedList;
  });
      ...
      return (
        ...
        >
          ...
          <button
            ...
            onClick={() => saveChanges(questions, mode)}
          >
            Save Changes
          </button>
        </div>
          ...
          {questions &&
            ...
            {hoveredCardId === el.id && (
                ...
                <div className="relative mb-auto w-full">
                  ...
                  <div className="group h-full w-full">
                    <Image
                      src={el.img || '/images/none-photo.png'}
                      className="block w-full rounded-lg"
                      alt={el.value || ''}
                      width={500}
                      height={500}
              ...
              <h3 className="text-2xl font-semibold mb-4">New</h3>
                ...
                <label className="block font-semibold mb-1">
                 ...
                 <input
                  ...
                  value={newQuestion.value || newQuestion.size}
                  className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
  ...
  ">
        ...
        <button
          type="button"
          className="mt-5 rounded-full bg-blue-500 px-4 py-2 font-semibold text-white hover:bg-blue-600 focus:ring-4 focus:ring-blue-200"
          onClick={() => saveChanges(questions, mode === 'WallHeights' ? 'wallHeights' : mode)}
        >
          Save Changes
        </button>
      </div>
